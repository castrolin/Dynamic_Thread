...
#include "StepProcess_Sticker.h"


CStepProcess_Sticker::CStepProcess_Sticker()
{
...
BOOL CStepProcess_Sticker::Do_MarkSearch(CString PatternName, double &Pos_Xpixel, double &Pos_Ypixel, double &Score, BOOL bSavePic,  FOV_ORG_TYPE nORG_Type)
{
	try
	{
		...
		ImageProc_PatternFind_MIL_Sticker->SetPatternName(PatternName);

		FileDirectory = FormatString("%s%s", FolderPath, csDate);

		CCD_FOV_Width = ImageGraber_Hikvision_Sticker->m_Info.nImageWidth;
		CCD_FOV_Height = ImageGraber_Hikvision_Sticker->m_Info.nImageHeight;

		if(ImageGraber_Hikvision_Sticker->IsCameraOpen() == false)
		{
			ImageGraber_Hikvision_Sticker->CheckConnection();
			return FALSE;
		}
		...
		int nThreshold = ProcessRecipe->Recipe_Data.st_RecipeData.nThreshold_Sticker;
		int nBlur = ProcessRecipe->Recipe_Data.st_RecipeData.nBlur_Sticker;
		...
		*/
		...
		pImagePtr = ImageGraber_Hikvision_Sticker->GrabSigleImageBuffer(ImageWidth, ImageHeight, ImageDepth, nThreshold, nBlur);

		if(pImagePtr == NULL)
			return FALSE;

		if(ImageProc_PatternFind_MIL_Sticker->PatternFind(pImagePtr, ImageWidth, ImageHeight, ImageDepth, PatternFindResult, nORG_Type) == TRUE)
		{
			...
			case FOV_ORG_TYPE_LEFTBOTTOM:
				...
				m_nImagePos_Y = ImageGraber_Hikvision_Sticker->GetImageHeight() - PatternFindResult.pos_Y;////(int)PatternFindResult.pos_Y
				break;
			case FOV_ORG_TYPE_RIGHTTOP:
				m_nImagePos_X = (int)PatternFindResult.pos_X + ImageGraber_Hikvision_Sticker->GetImageWidth();
				m_nImagePos_Y = -(int)PatternFindResult.pos_Y;
				break;
			case FOV_ORG_TYPE_RIGHTBOTTOM:
				m_nImagePos_X = (int)PatternFindResult.pos_X + ImageGraber_Hikvision_Sticker->GetImageWidth();
				m_nImagePos_Y = ImageGraber_Hikvision_Sticker->GetImageHeight() - (int)PatternFindResult.pos_Y;
				break;
			case FOV_ORG_TYPE_CENTER:
				m_nImagePos_X = (int)PatternFindResult.pos_X + ImageGraber_Hikvision_Sticker->GetImageWidth() / 2;
				m_nImagePos_Y = ImageGraber_Hikvision_Sticker->GetImageHeight() / 2 - (int)PatternFindResult.pos_Y;
				break;
			...
			if(bSavePic == TRUE)
			{
				ImageGraber_Hikvision_Sticker->SaveGrabSigleImageBuffer(m_FilePath_Org);

				ImageGraber_Hikvision_Sticker->SaveGrabSigleImageBufferWithLabel(m_FilePath_Ret, FormatString("Pos_X = %.3lf, Pos_Y = %.3lf,Score=%.3lf", PatternFindResult.pos_X, PatternFindResult.pos_Y,PatternFindResult.Score), (UINT)m_nImagePos_X, (UINT)m_nImagePos_Y);
	...
	{
		e.SetLocation("Sticker Do_MarkSearch");
		throw;
...
BOOL CStepProcess_Sticker::Do_MarkSearch( CString PatternName_L, CString PatternName_R, POINT_DATA_2F &Pos_L, POINT_DATA_2F &Pos_R, BOOL bSavePic, FOV_ORG_TYPE nORG_Type )
{
	try
	{
		CDiskObject DiskObject;
		...
		if(ImageProc_PatternFind_MIL_Sticker->PatternFind(pImagePtr, ImageWidth, ImageHeight, ImageDepth, PatternName_L, PatternName_R, PatternFindResult_L, PatternFindResult_R, nORG_Type) == TRUE)
		{
			...
			case FOV_ORG_TYPE_LEFTBOTTOM:
				...
				m_nImagePosL_Y = ImageGraber_Hikvision_Sticker->GetImageHeight() - PatternFindResult_L.pos_Y;////(int)PatternFindResult.pos_Y
				m_nImagePosR_X = PatternFindResult_R.pos_X;////強轉刪除  (int)PatternFindResult.pos_X
				m_nImagePosR_Y = ImageGraber_Hikvision_Sticker->GetImageHeight() - PatternFindResult_R.pos_Y;////(int)PatternFindResult.pos_Y
				break;
			case FOV_ORG_TYPE_RIGHTTOP:
				m_nImagePosL_X = (int)PatternFindResult_L.pos_X + ImageGraber_Hikvision_Sticker->GetImageWidth();
				m_nImagePosL_Y = -(int)PatternFindResult_L.pos_Y;
				m_nImagePosR_X = (int)PatternFindResult_R.pos_X + ImageGraber_Hikvision_Sticker->GetImageWidth();
				m_nImagePosR_Y = -(int)PatternFindResult_R.pos_Y;
				break;
			case FOV_ORG_TYPE_RIGHTBOTTOM:
				m_nImagePosL_X = (int)PatternFindResult_L.pos_X + ImageGraber_Hikvision_Sticker->GetImageWidth();
				m_nImagePosL_Y = ImageGraber_Hikvision_Sticker->GetImageHeight() - (int)PatternFindResult_L.pos_Y;
				m_nImagePosR_X = (int)PatternFindResult_R.pos_X + ImageGraber_Hikvision_Sticker->GetImageWidth();
				m_nImagePosR_Y = ImageGraber_Hikvision_Sticker->GetImageHeight() - (int)PatternFindResult_R.pos_Y;
				break;
			case FOV_ORG_TYPE_CENTER:
				m_nImagePosL_X = (int)PatternFindResult_L.pos_X + ImageGraber_Hikvision_Sticker->GetImageWidth() / 2;
				m_nImagePosL_Y = ImageGraber_Hikvision_Sticker->GetImageHeight() / 2 - (int)PatternFindResult_L.pos_Y;
				m_nImagePosR_X = (int)PatternFindResult_R.pos_X + ImageGraber_Hikvision_Sticker->GetImageWidth() / 2;
				m_nImagePosR_Y = ImageGraber_Hikvision_Sticker->GetImageHeight() / 2 - (int)PatternFindResult_R.pos_Y;
				break;
			case FOV_ORG_TYPE_ORG:
				m_nImagePosL_X = (int)PatternFindResult_L.pos_X;
				m_nImagePosL_Y = (int)PatternFindResult_L.pos_Y;
			...
			if(bSavePic == TRUE)
			{
				...
				ImageGraber_Hikvision_Sticker->SaveGrabSigleImageBufferWithLabel(m_FilePath_Ret, (UINT)m_nImagePosL_X, (UINT)m_nImagePosL_Y, (UINT)m_nImagePosR_X, (UINT)m_nImagePosR_Y);
			}
...
BOOL CStepProcess_Sticker::Do_CCDAlign(POINT_DATA_2F &RetPoint_L, POINT_DATA_2F &RetPoint_R, double &Offset_X, double &Offset_Y, double &Offset_T, BOOL bSavePic)
{
	try
	{
		...
		AlignmentData.O_dX1 = ProcessRecipe->Recipe_Data.st_RecipeData.nOrgPosPixel_Sticker_LX;
		AlignmentData.O_dY1 = ProcessRecipe->Recipe_Data.st_RecipeData.nOrgPosPixel_Sticker_LY;

		AlignmentData.O_dX2 = ProcessRecipe->Recipe_Data.st_RecipeData.nOrgPosPixel_Sticker_RX;
		AlignmentData.O_dY2 = ProcessRecipe->Recipe_Data.st_RecipeData.nOrgPosPixel_Sticker_RY;
...
ManualSelectCheck:
			...
			if(SystemParams->GetSystemParamData()->bManualClickResult == TRUE)
			{
				...
				SystemStatusDlg->SetResultStatus_Sticker(FALSE, Point_L, Point_R, 0, 0, 0);
				StepFuncDlg_Sticker->SetResultStatus(Point_L, Point_R, 0, 0, 0);
				...
				SystemStatusDlg->ShowClickPos_Sticker(CImageProc_PictureShowUnit::SHOW_CLICK_POS_DOWN);
				StepFuncDlg_Sticker->ShowClickPos(CImageProc_PictureShowUnit::SHOW_CLICK_POS_DOWN);
				RobotStepFuncDlg->ShowClickPos(CImageProc_PictureShowUnit::SHOW_CLICK_POS_DOWN);

				SystemStatusDlg->ShowResultPos_Sticker(FALSE);
				StepFuncDlg_Sticker->ShowResultPos(FALSE);
				RobotStepFuncDlg->ShowResultPos(FALSE);

				ShowSystemMessageBox("System", "請手動於圖片中選擇位置並按下\"Manual Check\"，完成後流程會繼續執行", TRUE);

				SystemStatusDlg->ShowManualClickResultShowButton_Sticker(TRUE);
				StepFuncDlg_Sticker->ShowManualClickResultShowButton(TRUE);
				...
				SystemStatusDlg->ShowManualClickResultShowButton_Sticker(FALSE);
				StepFuncDlg_Sticker->ShowManualClickResultShowButton(FALSE);
				...
				if(SystemStatusDlg->IsWindowVisible() == TRUE)
					SystemStatusDlg->GetManualClickResult_Sticker(Man_Point_R, Man_Point_L);

				if(StepFuncDlg_Sticker->IsWindowVisible() == TRUE)
					StepFuncDlg_Sticker->GetManualClickResult(Man_Point_R, Man_Point_L);
				...
				SystemStatusDlg->ShowClickPos_Sticker(CImageProc_PictureShowUnit::SHOW_CLICK_POS_NONE);
				StepFuncDlg_Sticker->ShowClickPos(CImageProc_PictureShowUnit::SHOW_CLICK_POS_NONE);
				RobotStepFuncDlg->ShowClickPos(CImageProc_PictureShowUnit::SHOW_CLICK_POS_NONE);

				SystemStatusDlg->ShowResultPos_Sticker(TRUE);
				StepFuncDlg_Sticker->ShowResultPos(TRUE);
		...
		if(AlignmentProcess_Sticker->Alignment(RecipeName, AlignmentData, Offset_X, Offset_Y, Offset_T) == false)
		{
			Offset_X = 0;
			Offset_Y = 0;
			Offset_T = 0;
		...
		AlignmentProcess_Sticker->GetPixelSize(RecipeName, fPixelSize);
		...
		if(fabs(Offset_X) > SystemParams->GetSystemParamData()->OverRange_Sticker_mm_X && SystemParams->GetSystemParamData()->OverRange_Sticker_mm_X != 0)
		{
			LOG->Message_Error(Log_Main, "Sticker X 超過範圍, 請確認!");
		...
		if(fabs(Offset_Y) > SystemParams->GetSystemParamData()->OverRange_Sticker_mm_Y && SystemParams->GetSystemParamData()->OverRange_Sticker_mm_Y != 0)
		{
			LOG->Message_Error(Log_Main, "Sticker Y 超過範圍, 請確認!");
		...
		if(fabs(Offset_T) > SystemParams->GetSystemParamData()->OverRange_Sticker_mm_T && SystemParams->GetSystemParamData()->OverRange_Sticker_mm_T != 0)
		{
			LOG->Message_Error(Log_Main, "Sticker T 超過範圍, 請確認!");
...
BOOL CStepProcess_Sticker::Do_WaitForRobotCalibrateSignal_ORG( DWORD Timeout )
{
	try
	{
...
BOOL CStepProcess_Sticker::Do_WaitForRobotCalibrateSignal_DIS( DWORD Timeout )
{
	try
	{
		DWORD EndTime = GetTickCount() + Timeout;
...
BOOL CStepProcess_Sticker::Do_WaitForRobotCalibrateSignal_ANGLE( DWORD Timeout )
{
	try
	{
		DWORD EndTime = GetTickCount() + Timeout;
...
BOOL CStepProcess_Sticker::Proc_CCD_Calibrate()
{
	try
	{
		...
		EpsonRC_TCPIP_Ctrl->SetProgramValue("g_CalDis", SystemParams->GetSystemParamData()->CCD_Calibrate_Sticker_Distance);
		EpsonRC_TCPIP_Ctrl->SetProgramValue("g_CalAngle", SystemParams->GetSystemParamData()->CCD_Calibrate_Sticker_Degree);


		//Execute Epson Job
		EpsonRC_TCPIP_Ctrl->ExecuteControllerFunc(16);

		//Wait for Input signal
		if(Do_WaitForRobotCalibrateSignal_ORG(nTimeout) == FALSE)
		{
			nErrorCode = _ALARM_PROC_STEPPROCESS_TAPE_RB_SIGNAL_ORG_TIMEOUT;
		...
		if(SystemParams->m_SystemParamData.bDummyCamera == FALSE)
		{
			...
			{
				bRet = FALSE;
				nErrorCode = _ALARM_PROC_STEPPROCESS_TAPE_PATTERN_FIND_FAIL;
			...
			else
			{
				...
				SystemStatusDlg->SetResultStatus( bRet, Point_ORG_L, Point_ORG_R, 0.0, 0.0, 0.0);
				StepFuncDlg_Sticker->SetResultStatus( Point_ORG_L, Point_ORG_R, 0.0, 0.0, 0.0);
			}
		}
		else
		{
		...
		{
			nErrorCode = _ALARM_PROC_STEPPROCESS_TAPE_RB_SIGNAL_DIS_TIMEOUT;
		...
		if(SystemParams->m_SystemParamData.bDummyCamera == FALSE)
		{
			...
			else
			{
				LOG->Message_Log(Log_Main, "Mark Search Result = OK");
				SystemStatusDlg->SetResultStatus(bRet, Point_MOVE_L, Point_MOVE_R, 0.0, 0.0, 0.0);
				StepFuncDlg_Sticker->SetResultStatus( Point_MOVE_L, Point_MOVE_R, 0.0, 0.0, 0.0);
			}
		}
		else
		{
		...
		{
			nErrorCode = _ALARM_PROC_STEPPROCESS_TAPE_RB_SIGNAL_ANGLE_TIMEOUT;
		...
		if(SystemParams->m_SystemParamData.bDummyCamera == FALSE)
		{
			...
			else
			{
				LOG->Message_Log(Log_Main, "Mark Search Result = OK");
				SystemStatusDlg->SetResultStatus(bRet, Point_ROTATE_L, Point_ROTATE_R, 0.0, 0.0, 0.0);
				StepFuncDlg_Sticker->SetResultStatus( Point_ROTATE_L, Point_ROTATE_R, 0.0, 0.0, 0.0);
			}
		}
		else
		{
		...
		if(AlignmentProcess_Sticker->Calibrate(RecipeName, CalibrateData, SystemParams->m_SystemParamData.CCD_Calibrate_Sticker_Distance, SystemParams->m_SystemParamData.CCD_Calibrate_Sticker_Degree) == false)
			bRet = FALSE;
		...
		if(bError == true)
		{
			...
			throw SYSTEM_ERROR("CStepProcess_Sticker::Proc_CCD_Calibrate", _MODULE_ERROR_EPSON_RC, &nErrorCode);
			return FALSE;
		}
		...
		{
			DWORD nErrorCode = _ALARM_PROC_STEPPROCESS_ROBOT_CALI_TAPE_TIMEOUT;
			throw SYSTEM_ERROR("CStepProcess_Sticker::Proc_CCD_Calibrate", _MODULE_ERROR_PROCESS, &nErrorCode);
...
BOOL CStepProcess_Sticker::Proc_CCD_Align(double &dOffset_X, double &dOffset_Y, double &dOffset_T)
{
	...
	try
	{
		...
		LOG->Message_Log(Log_Main, "Sticker CCD Alignment Request Start");
		...
		LOG->Message_Log(Log_Main, "Sticker CCD Alignment Request Complete");

		if(bRet == TRUE)
		{
			LOG->Message_Log(Log_Main, "Sticker CCD Alignment Result = OK, Offset_X = %.3lf, Offset_Y = %.3lf", dOffset_X, dOffset_Y, dOffset_T);
			SystemStatusDlg->SetResultStatus_Sticker(bRet, Point_L, Point_R, dOffset_X, dOffset_Y, dOffset_T);
		}
		else
		{
			LOG->Message_Log(Log_Main, "Sticker CCD Alignment Result = NG, Offset_X = %.3lf, Offset_Y = %.3lf", dOffset_X, dOffset_Y, dOffset_T);
			SystemStatusDlg->SetResultStatus_Sticker(bRet, Point_L, Point_R, dOffset_X, dOffset_Y, dOffset_T);
		}
		...
		OrgVec.Vector_X = ProcessRecipe->Recipe_Data.st_RecipeData.nOrgPosPixel_Sticker_RX - ProcessRecipe->Recipe_Data.st_RecipeData.nOrgPosPixel_Sticker_LX;
		OrgVec.Vector_Y = ProcessRecipe->Recipe_Data.st_RecipeData.nOrgPosPixel_Sticker_RY - ProcessRecipe->Recipe_Data.st_RecipeData.nOrgPosPixel_Sticker_LY;
	...
	{
		e.SetLocation("Sticker Do_ProductPosDetectProces");
		throw;
...
BOOL CStepProcess_Sticker::Do_ManualClickResultComplete()
{
